    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="px-3 sm:px-4 py-2 sm:py-3 border-b border-gray-200">
        <div className="flex items-center">
          ...
          <h1 className="text-base sm:text-lg font-bold text-gray-900">Earn Points</h1>
        </div>
      </div>
      ...
      <div className="px-4 sm:px-6 pb-20 sm:pb-24">
        ...
        {/* Points Banner */}
        <div className="bg-blue-50 rounded-lg p-3 sm:p-4 mb-6 sm:mb-8 flex items-center">
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <button
            ...
            className="w-full bg-green-500 text-white rounded-lg px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between hover:bg-green-600 transition-colors duration-200"
          >
            <div className="flex items-center">
              <div className="w-6 h-6 sm:w-8 sm:h-8 bg-white rounded-full flex items-center justify-center mr-2 sm:mr-3">
                <span className="text-green-500 font-bold text-sm sm:text-lg">W</span>
              </div>
              <span className="text-sm sm:text-base font-medium">Share on WhatsApp</span>
            </div>
            <span className="text-green-100 text-sm sm:text-base font-medium">+50 pts</span>
          </button>

          {/* Instagram */}
          <button
            onClick={() => handleShare("Instagram")}
            className="w-full bg-white border-2 border-gray-300 rounded-lg px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between hover:bg-gray-50 transition-colors duration-200"
          >
            <div className="flex items-center">
              <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center mr-2 sm:mr-3">
                <svg
                  className="w-4 h-4 sm:w-5 sm:h-5 text-white"
                  fill="currentColor"
                  viewBox="0 0 24 24"
            ...
            <span className="text-gray-600 text-sm sm:text-base font-medium">+50 pts</span>
          </button>
        ...
        <div className="text-center mt-8 sm:mt-12">
          <button
            onClick={handleSkip}
            className="text-sm sm:text-base text-gray-600 hover:text-gray-800 transition-colors duration-200"
          >
            Skip for now
          </button>
        </div>
